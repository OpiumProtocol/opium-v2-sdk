...
var WrappedOracleAggregator = /** @class */ (function () {
    ...
    WrappedOracleAggregator.prototype.getData = function (_oracleId, _timestamp, _overrides) {
        if (_overrides === void 0) { _overrides = {}; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                try {
    ...
    WrappedOracleAggregator.prototype.hasData = function (_oracleId, _timestamp, _overrides) {
        if (_overrides === void 0) { _overrides = {}; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                try {
    ...
    return WrappedOracleAggregator;
}());
exports.WrappedOracleAggregator = WrappedOracleAggregator;
//# sourceMappingURL=wrappedOracleAggregator.js.map