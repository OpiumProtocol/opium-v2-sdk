...
// services
var contractService_1 = require("../factoryService/contractService");
...
var SimulatorService = /** @class */ (function () {
    ...
    SimulatorService.prototype.computePositionsAddressesByDerivative = function (_derivative) {
        return __awaiter(this, void 0, void 0, function () {
            var onChainPositionsLens, _a, longPositionAddress, shortPositionAddress;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, {
                                longPositionAddress: longPositionAddress,
                                shortPositionAddress: shortPositionAddress,
                            }];
                }
            });
        });
    };
    SimulatorService.prototype.computePositionsAddressesByDerivativeHash = function (_derivativeHash) {
        return __awaiter(this, void 0, void 0, function () {
            var onChainPositionsLens, _a, longPositionAddress, shortPositionAddress;
            return __generator(this, function (_b) {
                switch (_b.label) {
